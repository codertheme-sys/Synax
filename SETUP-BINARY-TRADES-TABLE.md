# Binary Trades Table Setup

## Sorun
`binary_trades` tablosu veritabanında mevcut değil. Bu yüzden trade işlemleri başarısız oluyor.
...
### Adım 3: Kontrol Et
SQL başarıyla çalıştırıldıktan sonra:
1. Sol menüden **Table Editor**'e gidin
2. `binary_trades` tablosunun göründüğünü kontrol edin
3. Şimdi trade işlemlerini tekrar deneyin

## Not
Eğer "policy already exists" gibi bir hata alırsanız, policy'leri kaldırmadan önce kontrol edin veya sadece tablo oluşturma kısmını çalıştırın.
