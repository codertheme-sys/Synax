...
export const supabase = createClient(
  ...
  supabaseAnonKey || 'placeholder-key',
  {
    auth: {
      ...
      // Implicit flow: password-reset emails carry tokens in the URL hash and work when
      // the user opens the link from any browser/device. PKCE requires code_verifier in
      // localStorage from the same browser that called resetPasswordForEmail.
      flowType: 'implicit',
