...
const kpis = [
  ...
  { label: 'Open Positions', value: '7', delta: '-1 today', positive: false },
...
function DashboardPage() {
  ...
  const [kpis, setKpis] = useState([
    ...
    { label: 'Open Positions', value: '0', delta: '0', positive: true },
        ...
        if (result.success && result.data) {
          ...
          setKpis([
            ...
            { 
              ...
              value: (data.kpis?.openPositions || 0).toString(), 
              delta: 'Active', 
              positive: true 
            },
            { 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#080915] via-[#0b0c1a] to-[#0d0f25] text-white pb-16">
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 pt-16 space-y-10">
        ...
        <div className={`grid ${isMobile ? 'grid-cols-2' : 'grid-cols-4'} gap-3 sm:gap-4`} data-reveal>
          {kpis.map((kpi) => (
            <div
              key={kpi.label}
              style={{
        ...
        <section data-reveal>
          <div style={{
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full" style={{ borderCollapse: 'collapse' }} data-reveal>
                <thead>
        ...
        {/* Open Positions & Recent Deposits - Side by Side */}
        <section 
          style={{ 
            display: 'grid', 
        ...
        >
          <div style={{
            ...
            <div className="flex items-center justify-between mb-3">
              <h2 style={{ fontSize: '18px', fontWeight: 700 }}>Open Positions</h2>
              ...
              <table className="min-w-full" style={{ borderCollapse: 'collapse' }} data-reveal>
                <thead>
                  <tr style={{ borderBottom: '2px solid rgba(139, 92, 246, 0.3)' }}>
                    <th style={{ paddingTop: '8px', paddingBottom: '8px', paddingLeft: '0', paddingRight: '10px', fontSize: '10px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#9ca3af', textAlign: 'left' }}>Symbol</th>
                    <th style={{ paddingTop: '8px', paddingBottom: '8px', paddingRight: '10px', fontSize: '10px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#9ca3af', textAlign: 'left' }}>Side</th>
                    <th style={{ paddingTop: '8px', paddingBottom: '8px', paddingRight: '10px', fontSize: '10px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#9ca3af', textAlign: 'left' }}>Size</th>
                    <th style={{ paddingTop: '8px', paddingBottom: '8px', paddingRight: '10px', fontSize: '10px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#9ca3af', textAlign: 'left' }}>Entry</th>
                    <th style={{ paddingTop: '8px', paddingBottom: '8px', paddingRight: '10px', fontSize: '10px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#9ca3af', textAlign: 'left' }}>P&amp;L</th>
                  </tr>
                </thead>
                <tbody>
                  {positions.length === 0 ? (
                    ...
                    <tr
                      key={p.symbol}
                      style={{
                        borderBottom: idx < positions.length - 1 ? '1px solid rgba(255, 255, 255, 0.08)' : 'none',
                        transition: 'all 0.2s ease',
                      }}
                      onMouseEnter={(e) => {
                    ...
                    >
                      <td style={{ paddingTop: '10px', paddingBottom: '10px', paddingLeft: '0', paddingRight: '10px', fontSize: '12px', fontWeight: 700, color: '#ffffff' }}>{p.symbol}</td>
                      <td style={{ paddingTop: '10px', paddingBottom: '10px', paddingRight: '10px', fontSize: '12px' }}>
                        <span
                          style={{
                            ...
                            fontSize: '10px',
                            fontWeight: 700,
                            background: p.side === 'Long' ? 'rgba(34, 197, 94, 0.2)' : 'rgba(239, 68, 68, 0.2)',
                            color: p.side === 'Long' ? '#4ade80' : '#f87171',
                            border: `1px solid ${p.side === 'Long' ? 'rgba(34, 197, 94, 0.4)' : 'rgba(239, 68, 68, 0.4)'}`,
                            boxShadow: p.side === 'Long' ? '0 0 8px rgba(34, 197, 94, 0.3)' : '0 0 8px rgba(239, 68, 68, 0.3)',
                          }}
                        >
                          {p.side}
                        </span>
                      </td>
                      <td style={{ paddingTop: '10px', paddingBottom: '10px', paddingRight: '10px', fontSize: '12px', color: '#d1d5db', fontWeight: 500 }}>{p.size}</td>
                      <td style={{ paddingTop: '10px', paddingBottom: '10px', paddingRight: '10px', fontSize: '12px', color: '#d1d5db', fontWeight: 500 }}>{p.entry}</td>
                      <td style={{ paddingTop: '10px', paddingBottom: '10px', paddingRight: '10px', fontSize: '13px', fontWeight: 800, color: '#4ade80', textShadow: '0 0 10px rgba(34, 197, 94, 0.5)' }}>{p.pnl}</td>
                    </tr>
                    ))
                  )}
                </tbody>
                  ...
                  {allPayments.length === 0 ? (
                    ...
                    allPayments.map((payment, idx) => {
                      ...
                      if (payment.type === 'deposit') {
                        ...
                        // For withdrawals, check admin_notes or payment_method
